...
class Words extends React.Component {
    ...
    _get() {//database 접속한 후 데이터를 가져오는 함수
    ...
    _post(word) {//database에 데이터를 삽입하는 함수
    ...
    handleDelete = (id) => {//사용자가 삭제 버튼을 눌렀을 때
        this._delete(id);
    }
    componentDidMount() {//컴포넌트(페이지)가 구성된 다음에 자동으로 호출되는 함수
        this._get();
    }



    render() {//Grid 2갈래로 나눈다.
            ...
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        ...
                        <TextField label="가중치" type="text" name="weight" value={this.state.word} onChange={this.handleValueChange} /><br />
                    </DialogContent>
                    <DialogActions>
